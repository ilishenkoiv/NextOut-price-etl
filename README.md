...
current roulette every 30 minutes, then builds a new roulette snapshot. A confirmed fare updates the
...
fetch` is queued or running, the 30-minute refresh skips its work. A successful main sweep triggers
