...
export const CITIES = {
  ...
  // ── East Asia expansion (2026-07-18). NRT shares Tokyo's query (same city as HND).
  PEK: { city: 'Beijing', country: 'China' },
  PVG: { city: 'Shanghai', country: 'China' },
  CAN: { city: 'Guangzhou', country: 'China' },
  TFU: { city: 'Chengdu', country: 'China' },
  NRT: { city: 'Tokyo', country: 'Japan', photoQuery: 'Tokyo Japan' },
  CTS: { city: 'Sapporo', country: 'Japan' },
  FUK: { city: 'Fukuoka', country: 'Japan' },
  PUS: { city: 'Busan', country: 'South Korea' },
  CJU: { city: 'Jeju', country: 'South Korea', photoQuery: 'Jeju island South Korea' },
